...
> By [Addy Osmani](https://x.com/addyosmani) (@addyosmani). Originally published on X: [original post](https://x.com/addyosmani/status/2064127981161959567). Republished here as plain Markdown for agent-friendly consumption.
...
[@steipete](https://x.com/steipete) recently said: "You shouldn't be prompting coding agents anymore. You should be designing loops that prompt your agents." Similarly, [@bcherny](https://x.com/bcherny), head of Claude Code at Anthropic, said "I don't prompt Claude anymore. I have loops running that prompt Claude and figuring out what to do. My job is to write loops".
...
md2md:
  protocol: "1.1.0"
  version: "1.0.0"
  canonical: "https://loopengineering.md"
  sync: 24h
  suggested_file: "loopengineering.md"
